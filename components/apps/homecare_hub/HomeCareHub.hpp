...
private:
    ...
    lv_obj_t *_top_weather_label;
    lv_obj_t *_mode_label;
    lv_obj_t *_status_label;
    lv_obj_t *_privacy_label;
    lv_obj_t *_weather_city_label;
    lv_obj_t *_weather_label;
    lv_obj_t *_weather_temp_label;
    lv_obj_t *_weather_summary_label;
    lv_obj_t *_aqi_label;
    lv_obj_t *_co2_label;
    lv_obj_t *_noise_label;
    lv_obj_t *_outdoor_label;
    lv_obj_t *_humidity_label;
    lv_obj_t *_air_label;
    lv_obj_t *_indoor_label;
    lv_obj_t *_night_label;
    lv_obj_t *_hero_kicker_label;
    lv_obj_t *_hero_room_label;
    lv_obj_t *_hero_text_label;
    lv_obj_t *_security_chip_label;
    lv_obj_t *_comfort_temp_label;
    lv_obj_t *_comfort_status_label;
    lv_obj_t *_temp_arc;
    lv_obj_t *_light_label;
    lv_obj_t *_power_label;
    lv_obj_t *_online_count_label;
    lv_obj_t *_camera_status_label;
    lv_obj_t *_assistant_text_label;
    ...
    std::array<lv_obj_t *, 4> _scene_cards;
    std::array<lv_obj_t *, 4> _scene_name_labels;
    std::array<lv_obj_t *, 4> _scene_desc_labels;
    std::array<lv_obj_t *, 4> _device_cards;
    std::array<lv_obj_t *, 4> _device_state_labels;
    std::array<lv_obj_t *, 4> _device_switches;
    std::array<lv_obj_t *, 4> _energy_bars;
    std::array<lv_obj_t *, 4> _energy_value_labels;
};
